...
import registerImage from "../assets/register.webp"; // ✅ Correct image import name
    ...
    <div className="flex min-h-screen">
      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center items-center p-8 md:p-12">
        <form
          ...
          className="w-full bg-white p-8 max-w-md rounded-lg shadow-sm"
        >
      ...
      <div className="hidden md:block w-1/2 bg-white">
        <div className="h-full flex flex-col justify-center items-center">
          <img
            src={registerImage} // ✅ Correct usage
            alt="Register"
